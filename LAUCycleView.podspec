#
#  Be sure to run `pod spec lint LAUCycleView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Lausen" => "2865028820@qq.com" }
  # Or just: spec.author    = "Lausen"
  # spec.authors            = { "Lausen" => "2865028820@qq.com" }
  # spec.social_media_url   = "https://twitter.com/Lausen"
